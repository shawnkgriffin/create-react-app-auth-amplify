    ...
    if (values.signUp) {
      ...
      firebase
        ...
        .catch(function(error) {
          console.log(
            `SignIn createUserWithEmailAndPassword ${error.code}, ${error.message}`,
          );
          setValues({
            ...values,
            error: error.message,
      ...
      firebase
        ...
        .catch(function(error) {
          // Handle Errors here.
          console.log(
            `SignIn signInWithEmailAndPassword failed ${error.code}, ${error.message}`,
          );
          setValues({
            ...values,
            error: error.message,
